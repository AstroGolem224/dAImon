...
- **Bekannte Lücken (24.08., T-6.8.v):** B5 (Ohren-Kill-Switch löscht den Hub-Automaten nicht) ist behoben (Commit `461b4c2`). Auf Anweisung zurückgestellt, nicht behoben:
  ...
  - **B4, B9 (pruefstandsfehler, offen):** der Zulauf-Wächter für den Aktionsweg sucht am falschen Ort; `SONDERFALL_UNITS` im Test ist veraltet (exec/input fehlen grundlos im Messband).
