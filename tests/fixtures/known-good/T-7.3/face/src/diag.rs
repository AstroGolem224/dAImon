...
pub struct FaceState {
    ...
    /// T-7.3: +1 je tatsaechlich gemaltem Mitschnitt-Punkt. Getrennt vom
    /// Sprachindikator, weil er etwas anderes sagt -- und weil der
    /// Verifizierer die Sprite-Aenderung an DIESEM Zaehler nachweist und
    /// nicht an einer Selbstauskunft.
