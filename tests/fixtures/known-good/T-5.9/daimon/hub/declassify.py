        ...
        **Zwei Fehler uebereinander, beide am 17.08. gefunden.** Das Audit war
        ...
        try:
            self._audit.schreiben(
                ...
                # Der Umfang gehoert LESBAR in den Datensatz (Akzeptanz 4:
                # "Jede Freigabe landet im Audit mit Umfang und turn_id").
                # `prompt_shown` allein genuegt nicht -- `Audit.schreiben`
                # redigiert dieses Feld IMMER, und aus einem Abdruck laesst
                # sich nicht lesen, wie viel herausgegeben wurde. Zahlen aus
                # einer geschlossenen Aufzaehlung sind `trusted` (Design 5.2);
                # sie tragen keinen Bildschirminhalt, nur seine Menge.
                umfang=dict(umfang),
                grund=grund,
