    ...
    def aktion_anfrage(self, anfrage: object) -> dict:
        ...
        try:
            lauf = teile.ausfuehren(
                ...
                # ABWEICHUNG des Gut-Musters (siehe HERKUNFT.txt):
                # `quelle` entscheidet ueber die Direktbefehl-Ausnahme
                # (Design 263) und ist damit Hub-Eigentum. Ein
                # deterministischer Hub-Parser existiert nicht; also
                # ist jede Anfrage an diesem Endpunkt "modell" und
                # geht durch die Vorschau. Das Feld des Absenders wird
                # nicht gelesen.
                quelle="modell",
