...
# T-4.5, Akzeptanzpunkt 6: der Auftrag traegt keine Signatur, also traegt ihn
# die Leitung. Ueber DIESEN Socket laufen beide Richtungen des Auftragswegs --
# die Aktionsbitte des Minds hinein und die Ticketeinloesung des Brokers
# unmittelbar vor der Ausfuehrung. Ohne Allowlist ist "Herkunft ueber den
# Socket" hier eine Zusage ohne Vorrichtung: jeder Prozess derselben uid
# koennte eine Aktion bitten und jedes Ticket verbrennen.
#
# Die Liste ist die kleinstmoegliche: der Mind und genau die vier Broker aus
# BROKER_SOCKETS, deren Units unter config/systemd/ liegen. Ein Wegweiser,
# keine Authentifizierung (Design 1.3) -- ein same-uid-Angreifer legt sich
# eine eigene Unit an. Sie faengt Verwechslung und Fehlkonfiguration.
AKTION_UNITS = ("daimon-mind.service", "daimon-dbus.service",
                "daimon-fs.service", "daimon-exec.service",
