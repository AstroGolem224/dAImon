...
class PTTAutomat:
    ...
    def umschalten(self) -> bool:
        ...
        # MUTANT: Halten statt Umschaltung -- jeder Druck schaltet AN,
        # ausgeschaltet wird nur durch ein Loslass-Ereignis, das es bei
        # kglobalaccel nicht verlaesslich gibt.
