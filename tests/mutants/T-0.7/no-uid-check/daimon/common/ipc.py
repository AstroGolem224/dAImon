"""Mutante: SO_PEERPIDFD korrekt, aber ohne uid-Pruefung.
...
def authorize_peer(
    ...
    if message_type not in PRODUCER_TYPES.get(socket_producer, ()):
        _reject(conn, "Typ stimmt nicht", audit)
    # MUTATION: expected_uid wird nicht geprueft.
...
def accept(srv, produzent, *, erlaubte_uid=None, erlaubte_units=None, audit=None):
    ...
    try:
        ...
        # MUTATION: erlaubte_uid wird ignoriert.
