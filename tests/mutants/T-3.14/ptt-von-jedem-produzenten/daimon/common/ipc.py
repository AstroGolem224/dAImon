...
PRODUZENTEN: dict[str, frozenset[str]] = {
    ...
    "ears": frozenset({"utterance", "ptt"}),
    "eyes": frozenset({"screen", "ptt"}),
    "kwin": frozenset({"window", "ptt"}),
    ...
    "face": frozenset({"bubble_dismiss", "wahrnehmung_aus", "ptt"}),
