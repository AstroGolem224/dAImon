...
impl OverlaySurface {
    ...
    pub fn sprite_committen(
        ...
        let frame = frame_toenen(&atlas.frame(abbildung.zeile, 0)?, toenung);
    ...
    /// Blase unmapen und ihre eigene Input-Region sofort leeren.
    pub fn bubble_ausblenden(&mut self, compositor: &CompositorState) -> bool {
        ...
        self.bubble.surface.attach(None, 0, 0);
        self.bubble.surface.commit();
