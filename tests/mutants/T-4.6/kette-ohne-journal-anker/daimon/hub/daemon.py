...
class Hub:
    ...
    def audit_verankern(self) -> dict:
        ...
        if kette_kaputt:
            ...
            # Design 7.6: "meldet eine Abweichung als Bubble mit hoher
            # Dringlichkeit". Eine Zeile im Journal ist keine Meldung an
            # den Nutzer -- sie muss man suchen.
            self.state.apply("failed", session_id="audit",
                             bubble={"title": "Audit-Kette gerissen",
                                     "body": "; ".join(kette_kaputt)[:240],
                                     "urgent": True})
        else:
